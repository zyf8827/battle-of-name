      ...
      <div className="w-full max-w-2xl rounded-3xl border border-slate-700/50 bg-slate-900/60 p-8 shadow-2xl backdrop-blur-md md:p-12">
        <div className="mb-10 text-center">
          ...
          <p className="text-sm font-medium text-slate-400">
            输入姓名，启动一场<span className="text-sky-400">随机</span>且<span className="text-indigo-400">独特</span>的文字直播对战
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="group relative">
            ...
            />
            <div className="absolute right-4 top-1/2 -translate-y-1/2 text-xl opacity-50">🥷</div>
          </div>
          ...
          <div className="group relative">
            ...
            />
            <div className="absolute right-4 top-1/2 -translate-y-1/2 text-xl opacity-50">🧙‍♂️</div>
          </div>
        </div>

        <div className={`overflow-hidden transition-all duration-300 ease-in-out ${showSeedInput ? 'max-h-24 mt-6 opacity-100' : 'max-h-0 opacity-0'}`}>
          <div className="relative">
            ...
            />
             <div className="absolute right-4 top-1/2 -translate-y-1/2 text-xs text-amber-500/50 font-mono">种子</div>
          </div>
        </div>
